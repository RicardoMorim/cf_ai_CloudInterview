/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6b0ed2da885badd6a24646c6f49ca1fc)
// Runtime types generated with workerd@1.20251125.0 2025-11-26 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Session";
	}
	interface Env {
		KV: KVNamespace;
		...
		CLOUDFLARE_AI_WORKER: string;
		CLOUDFLARE_KV_DATABASE: string;
		SESSION_NAMESPACE: DurableObjectNamespace<import("./src/index").Session>;
		AI: Ai;
	}
}
